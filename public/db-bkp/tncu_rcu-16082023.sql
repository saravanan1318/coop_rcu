...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2023 at 04:17 AM
...
(1, '1', '2', '2023-08-16', '45435', '34543543', '345', '34534534', '2023-08-15 19:17:14', '2023-08-15 19:17:14');
...
INSERT INTO `loan_collection` (`id`, `user_id`, `loan_id`, `collectiondate`, `scstno`, `scstamount`, `othersno`, `othersamount`, `totalno`, `totalamount`, `created_at`, `updated_at`) VALUES
(2, '1', '11', '2023-08-14', '345345', '43534', '543534', '543534', '888879', '587068', '2023-08-14 20:09:38', '2023-08-14 20:09:38'),
(3, '1', '3', '2023-08-15', '4', '40000', '8', '120000', '12', '160000', '2023-08-14 20:11:57', '2023-08-14 20:11:57'),
(4, '1', '12', '2023-08-08', '5', '2500', '15', '15000', '20', '17500', '2023-08-14 20:36:22', '2023-08-14 20:36:22');

-- --------------------------------------------------------

--
-- Table structure for table `loan_deposit`
--

CREATE TABLE `loan_deposit` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `loantype` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `issuedate` date NOT NULL,
...
CREATE TABLE `loan_issues` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `loan_id` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `issuedate` date NOT NULL,
  `scstno` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `scstamount` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `othersno` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `othersamount` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `totalno` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `loan_issues`
--

INSERT INTO `loan_issues` (`id`, `user_id`, `loan_id`, `issuedate`, `scstno`, `scstamount`, `othersno`, `othersamount`, `totalno`, `totalamount`, `created_at`, `updated_at`) VALUES
(1, '1', NULL, '2023-08-10', '43', '5674445', '33', '64543344', '76', '70217789', '2023-08-09 20:10:26', '2023-08-09 20:10:26'),
(2, '1', NULL, '2023-08-10', '12', '234', '12', '23424', '24', '23658', '2023-08-09 20:29:25', '2023-08-09 20:29:25'),
(3, '1', NULL, '2023-08-10', '100', '10000', '10', '100000', '110', '110000', '2023-08-09 23:33:48', '2023-08-09 23:33:48'),
(4, '1', NULL, '2023-08-03', '12', '1000', '10', '10000', '22', '11000', '2023-08-10 01:26:58', '2023-08-10 01:26:58'),
(5, '1', NULL, '2023-08-10', '12', '1231231', '112', '232323', '124', '1463554', '2023-08-10 04:44:43', '2023-08-10 04:44:43'),
(6, '1', NULL, '2023-08-05', '1', '100', '2', '3000', '3', '3100', '2023-08-11 01:57:38', '2023-08-11 01:57:38'),
(7, '1', NULL, '2023-08-04', '1', '20000', '2', '2000', '3', '22000', '2023-08-11 02:20:28', '2023-08-11 02:20:28'),
(8, '1', NULL, '2023-08-11', '100', '100000', '10', '2000000', '110', '2100000', '2023-08-11 07:16:49', '2023-08-11 07:16:49'),
(9, '1', '11', '2023-08-14', '4564645', '6456', '45645', '645645', '4610290', '652101', '2023-08-13 19:54:20', '2023-08-13 19:54:20'),
(10, '1', '3', '2023-08-15', '5', '200000', '10', '600000', '15', '800000', '2023-08-14 20:11:16', '2023-08-14 20:11:16'),
(11, '1', '12', '2023-08-08', '10', '10000', '25', '25000', '35', '35000', '2023-08-14 20:35:22', '2023-08-14 20:35:22');
...
--
-- Table structure for table `purchase_fertilizer`
--

CREATE TABLE `purchase_fertilizer` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `purchase_ffo`
--

CREATE TABLE `purchase_ffo` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
--
-- Table structure for table `purchase_ncc`
--

CREATE TABLE `purchase_ncc` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
--
-- Table structure for table `purchase_pdbunk`
--

CREATE TABLE `purchase_pdbunk` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
--
-- Table structure for table `purchase_pharmacy`
--

CREATE TABLE `purchase_pharmacy` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
--
-- Table structure for table `sales_fertilizer`
--

CREATE TABLE `sales_fertilizer` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
--
-- Table structure for table `sales_ffo`
--

CREATE TABLE `sales_ffo` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
--
-- Table structure for table `sales_ncc`
--

CREATE TABLE `sales_ncc` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
--
-- Table structure for table `sales_pdbunk`
--

CREATE TABLE `sales_pdbunk` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
--
-- Table structure for table `sales_pharmacy`
--

CREATE TABLE `sales_pharmacy` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` date NOT NULL,
...
(2, 'SuperAdmin', 'superadmin@rcs.com', NULL, '$2y$10$Xhj83E6umEZvVvr8CmY3k.ufhbonHO7ur.s2O7mhfdPEmZshOgM2W', NULL, 0, 0, 0, 2, '2023-08-09 19:02:18', '2023-08-09 19:02:18');
...
--
-- Indexes for table `loan_deposit`
--
ALTER TABLE `loan_deposit`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `purchase_fertilizer`
--
ALTER TABLE `purchase_fertilizer`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `purchase_ffo`
--
ALTER TABLE `purchase_ffo`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `purchase_ncc`
--
ALTER TABLE `purchase_ncc`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `purchase_pdbunk`
--
ALTER TABLE `purchase_pdbunk`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `purchase_pharmacy`
--
ALTER TABLE `purchase_pharmacy`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sales_fertilizer`
--
ALTER TABLE `sales_fertilizer`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sales_ffo`
--
ALTER TABLE `sales_ffo`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sales_ncc`
--
ALTER TABLE `sales_ncc`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sales_pdbunk`
--
ALTER TABLE `sales_pdbunk`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sales_pharmacy`
--
ALTER TABLE `sales_pharmacy`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `loan_deposit`
--
ALTER TABLE `loan_deposit`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `purchase_fertilizer`
--
ALTER TABLE `purchase_fertilizer`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `purchase_ffo`
--
ALTER TABLE `purchase_ffo`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `purchase_ncc`
--
ALTER TABLE `purchase_ncc`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `purchase_pdbunk`
--
ALTER TABLE `purchase_pdbunk`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `purchase_pharmacy`
--
ALTER TABLE `purchase_pharmacy`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sales_fertilizer`
--
ALTER TABLE `sales_fertilizer`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sales_ffo`
--
ALTER TABLE `sales_ffo`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sales_ncc`
--
ALTER TABLE `sales_ncc`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sales_pdbunk`
--
ALTER TABLE `sales_pdbunk`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sales_pharmacy`
--
ALTER TABLE `sales_pharmacy`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
