...
function setAge(d) {
    ...
    var asondate = new Date("01/01/2018");
    // var dob = new Date($("#DOB").val());
    var selectedDOB = $("#datetimepickerDOB").data("DateTimePicker").date();
...
$(document).ready(function (e) {
    ...
    $("#regform").submit(function (e) {
        ...
        $.confirm({
            title: 'Confirm?',
            content: 'Please review your given information before you submit.',
            buttons: {
                confirm: {
                    text: 'Submit',
                    btnClass: 'btn-blue',
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (status == "SUCCESS") {
                                    console.log("Success");
                                    $("#errormessage").hide();
                                    location.href = "/omcl/proceedtopayment.php?cid=" + message;
                                }
                            ...
                            error: function(data){
                                console.log("Error sniippet" + data);
                                alert("An error occured. Please check your information entered or try again after some time.");
                                $("#btnPayment").prop("disabled", false);
                            }
                        });
