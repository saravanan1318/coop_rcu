                        ...
                        <form action="{{url('/society/godown/store')}}" method="post" id="godownadd" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row margindiv">
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingName" name="capacity" placeholder="Your Others Amount." required>
                                            <label for="floatingName">Capacity (in metric Ton).</label>
                                        </div>
                                    </div>
