            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('/society/deposit/outstanding/store')}}" method="post" id="outstandingadd" class="row g-3">
                            @csrf
                            <div class="col-md-3">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary" id="outstandingsubmit">Submit</button>
                            </div>
