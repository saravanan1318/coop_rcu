<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <a href="index.html" class="logo d-flex align-items-center">
      ...
      <span class="d-none d-lg-block">Society Panel</span>
    </a>
    ...
    <ul class="d-flex align-items-center">
      <li class="nav-item dropdown pe-3">
        ...
        <a class="nav-link d-flex align-items-center pe-0" href="#" >
          <span class="d-none d-md-block  ps-2">{{isset($region)&& !empty($region)?"Region : " .$region->region_name." | ":""}}{{isset($circle)&& !empty($circle)? "Circle:".$circle->circle_name."  ":""}}</span>
        </a>
