                                ...
                                <table class="table table-responsive table-bordered" style="text-align: center">
                                    ...
                                    <tbody id="tbody">
                                        <tr data-id="1" id="row1">
                                            ...
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="govtnoofvarieties[]" id="govtnoofvarieties1" style=" width: 150px; " value="{{ old('govtnoofvarieties') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="govtquantity[]" id="govtquantity1" style=" width: 150px; " value="{{ old('govtquantity') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="govtvalues[]" id="govtvalues1" style=" width: 150px; " value="{{ old('govtvalues') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="coopnoofvarieties[]" id="coopnoofvarieties1" style=" width: 150px; " value="{{ old('coopnoofvarieties') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="coopquantity[]" id="coopquantity1" style=" width: 150px; " value="{{ old('coopquantity') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="coopvalues[]" id="coopvalues1" style=" width: 150px; " value="{{ old('coopvalues') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="jpcnoofvarieties[]" id="jpcnoofvarieties1" style=" width: 150px; " value="{{ old('jpcnoofvarieties') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="jpcquantity[]" id="jpcquantity1" style=" width: 150px; " value="{{ old('jpcquantity') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="jpcvalues[]" id="jpcvalues1" style=" width: 150px; " value="{{ old('jpcvalues') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="privatenoofvarieties[]" id="privatenoofvarieties1" style=" width: 150px; " value="{{ old('privatenoofvarieties') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="privatequantity[]" id="privatequantity1" style=" width: 150px; " value="{{ old('privatequantity') }}" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="privatevalues[]" id="privatevalues1" style=" width: 150px; " value="{{ old('privatevalues') }}" required>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
<script>
    ...
    $('#addrow').on('click', function() {
        ...
        var html = '<tr data-id="'+updatedrowadded+'" id="row'+updatedrowadded+'"> <td> <select class="form-control purchase_id" data-rowid="'+updatedrowadded+'" id="purchase_id'+updatedrowadded+'" style=" width: 150px; " name="purchase_id[]" ><option value="">--SELECT--</option> <?php foreach($mtr_purchases as $purchases){ ?> <option value="<?php echo $purchases->id ?>"><?php echo $purchases->purchase_name ?></option> <?php } ?> </select> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="govtnoofvarieties[]" style=" width: 150px; " id="govtnoofvarieties'+updatedrowadded+'" value="{{ old('govtnoofvarieties') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " name="govtquantity[]" id="govtquantity'+updatedrowadded+'" value="{{ old('govtquantity') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " name="govtvalues[]" id="govtvalues'+updatedrowadded+'" style=" width: 150px; " value="{{ old('govtvalues') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" name="coopnoofvarieties[]" style=" width: 150px; " id="coopnoofvarieties'+updatedrowadded+'" value="{{ old('coopnoofvarieties') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="coopquantity'+updatedrowadded+'" name="coopquantity[]" value="{{ old('coopquantity') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="coopvalues'+updatedrowadded+'" name="coopvalues[]" value="{{ old('coopvalues') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="jpcnoofvarieties'+updatedrowadded+'" name="jpcnoofvarieties[]" value="{{ old('jpcnoofvarieties') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  style=" width: 150px; " class="form-control" id="jpcquantity'+updatedrowadded+'" name="jpcquantity[]" value="{{ old('jpcquantity') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  style=" width: 150px; " class="form-control" id="jpcvalues'+updatedrowadded+'" name="jpcvalues[]" value="{{ old('jpcvalues') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="privatenoofvarieties'+updatedrowadded+'" name="privatenoofvarieties[]" value="{{ old('privatenoofvarieties') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  style=" width: 150px; " class="form-control" id="privatequantity'+updatedrowadded+'" name="privatequantity[]" style=" width: 150px; " value="{{ old('privatequantity') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" id="privatevalues'+updatedrowadded+'" style=" width: 150px; " name="privatevalues[]" value="{{ old('privatevalues') }}" required> </td> <td> <a  class="btn btn-danger deleterow" data-delete-id="'+updatedrowadded+'" onclick="deletethisrow('+updatedrowadded+')" >Delete</a> </td> </tr>';
