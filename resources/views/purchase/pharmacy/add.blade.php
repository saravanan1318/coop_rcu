        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{url('/society/purchase/pharmacy/store')}}" method="post" id="pharmacyadd" class="row g-3">
                    @csrf
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-6">
                        <div class="row margindiv">
                            <div class="col-md-12">
                                <div class="form-floating">
                                  <input type="date" class="form-control" id="floatingName" name="pharmacydate" placeholder="date" required>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-primary" id="pharmacysubmit">Submit</button>
                    </div>
