        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{url('/society/purchase/ffo/store')}}" method="post" id="ffoadd" class="row g-3">
                    @csrf
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-6">
                        <div class="row margindiv">
                            <div class="col-md-12">
                                <div class="form-floating">
                                  <input type="date" class="form-control" id="floatingName" name="ffodate" placeholder="date" required>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-primary" id="ffosubmit">Submit</button>
                    </div>
