                    ...
                    <div class="row margindiv">
                        ...
                        <div class="col-md-12" style="margin-top: 10px">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td><input type="number" name="disciplinary_ob_seventeena" class="form-control" required></td>
                                        <td><input type="number" name="initiated_during_month_seventeena" class="form-control" required></td>
                                        <td><input type="number" name="disciplinary_total_seventeena" class="form-control" readonly></td>
                                        <td><input type="number" name="disposed_this_month_seventeena" class="form-control" required></td>
                                        <td><input type="number" name="disciplinary_pending_seventeena" class="form-control" readonly></td>
                                        <td><input type="number" name="disciplinary_pending_percentage_seventeena" class="form-control" readonly></td>
                                    </tr>
                                </tbody>
                            </table>
                           ...
                           <div class="col-md-12" style="margin-top: 10px">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type="number" name="disciplinary_ob_seventeenb" class="form-control" required></td>
                                            <td><input type="number" name="initiated_during_month_seventeenb" class="form-control" required></td>
                                            <td><input type="number" name="disciplinary_total_seventeenb" class="form-control" readonly></td>
                                            <td><input type="number" name="disposed_this_month_seventeenb" class="form-control" required></td>
                                            <td><input type="number" name="disciplinary_pending_seventeenb" class="form-control" readonly></td>
                                            <td><input type="number" name="disciplinary_pending_percentage_seventeenb" class="form-control" readonly></td>
                                    </tr>
                                    </tbody>
                                </table>
                        <div class="col-md-10">
