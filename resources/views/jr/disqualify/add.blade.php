                    ...
                    <div class="row margindiv">
                        ...
                        <div class="col-md-12" style="margin-top: 10px">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="societies_ob" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="board_of_directors_ob" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="societies_im" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="board_of_directors_im" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="societies_total" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="board_of_directors_total" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="societies_dam" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="board_of_directors_dam" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="societies_pam" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="board_of_directors_pam" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="societies_pp" class="form-control" required></td>
                                        <td><input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  name="board_of_directors_pp" class="form-control" required></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
