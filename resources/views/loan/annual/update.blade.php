                    ...
                    <div class="col-md-6">
                        <div class="row margindiv">
                          <div class="col-md-12">
                              ...
                              <select class="form-control" id="floatingName" name="loan_id" value="{{ old('loan_id') }}"  required>
                                @foreach($mtr_loan as $loan)
                                  <option value="{{ $loan->id }}" {{$details->loan_id == $loan->id?"Selected":""}}>{{ $loan->loantype }}</option>
                                @endforeach
                              </select>
                        ...
                        <div class="row margindiv">
                            <div class="col-md-12">
                                <div class="form-floating">
                                  <input type="text" class="form-control" id="floatingName" name="overall_outstanding" placeholder="Your overall outstanding."  value="{{$details->overall_outstanding}}" required>
