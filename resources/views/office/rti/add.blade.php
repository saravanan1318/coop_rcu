                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url("/office/rti/store")}}" method="post" id="cmform" class="row g-3">
                                @csrf
                                <div class="row margindiv">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table  table-bordered" style=" ">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="date" name="appealDate" class="form-control" id="appealDate" required></td>
                                                    ...
                                                    <td><input type="text" name="orderPass" class="form-control" id="orderPass" required></td>
                                                    <td><input type="date" name="disposaldateofAppeal" class="form-control" id="disposaldateofAppeal" required></td>
                                                    <td><input type="date" name="TNIC" class="form-control" id="TNIC" required></td>
                                                    <td><input type="text" name="finalOrderPassed" class="form-control" id="finalOrderPassed" required></td>
