...
@section('content')
                                ...
                                <div class="col-md-12 table-responsive">
                                    ...
                                    <table class="table table-responsive table-bordered" style="text-align: center">
                                        ...
                                        <tr data-id="1" id="row1">
                                            ...
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="noofvarieties1" name="noofvarieties[]" value="{{ old('noofvarieties') }}" placeholder="" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="noofoutlets1" name="noofoutlets[]" value="{{ old('noofoutlets') }}" placeholder="" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="noofcustomers1" name="noofcustomers[]" value="{{ old('noofcustomers') }}" placeholder="" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="nooffarmers1" name="nooffarmers[]" value="{{ old('nooffarmers') }}" placeholder="" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="quantitykilo1" name="quantitykilo[]" value="{{ old('quantitykilo') }}" placeholder="" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="quantitylitres1" name="quantitylitres[]" value="{{ old('quantitylitres') }}" placeholder="" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="salesamountphysical1" name="salesamountphysical[]" value="{{ old('salesamountphysical') }}" placeholder="" required>
                                            </td>
                                            <td>
                                                <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="salesamountcoopbazaar1" name="salesamountcoopbazaar[]" value="{{ old('salesamountcoopbazaar') }}" placeholder="" required>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
    ...
    <script>
        ...
        $('#addrow').on('click', function() {
            ...
            var html = '<tr data-id="'+updatedrowadded+'" id="row'+updatedrowadded+'"> <td> <select class="form-control sale_id" data-rowid="'+updatedrowadded+'" id="sale_id'+updatedrowadded+'" style=" width: 150px; " name="sale_id[]" ><option value="">--SELECT--</option> <?php foreach($mtr_sales as $sales){ ?> <option value="<?php echo $sales->id ?>"><?php echo $sales->sale_name ?></option> <?php } ?> </select> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="noofvarieties'+updatedrowadded+'" name="noofvarieties[]" value="{{ old('noofvarieties') }}"  required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="noofoutlets'+updatedrowadded+'" name="noofoutlets[]" value="{{ old('noofoutlets') }}"  required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="noofcustomers'+updatedrowadded+'" name="noofcustomers[]" value="{{ old('noofcustomers') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="nooffarmers'+updatedrowadded+'" name="nooffarmers[]" value="{{ old('nooffarmers') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="quantitykilo'+updatedrowadded+'" name="quantitykilo[]" value="{{ old('quantitykilo') }}"  required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="quantitylitres'+updatedrowadded+'" name="quantitylitres[]" value="{{ old('quantitylitres') }}" required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="salesamountphysical'+updatedrowadded+'" name="salesamountphysical[]" value="{{ old('salesamountphysical') }}"  required> </td> <td> <input  type="number" min="0" step="any" onkeypress="return isNumberKey(event)"  class="form-control" style=" width: 150px; " id="salesamountcoopbazaar'+updatedrowadded+'" name="salesamountcoopbazaar[]" value="{{ old('salesamountcoopbazaar') }}" required> </td> <td> <a  class="btn btn-danger deleterow" data-delete-id="'+updatedrowadded+'" onclick="deletethisrow('+updatedrowadded+')" >Delete</a> </td> </tr>';
