    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Providing Seeds</li>
    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Providing Seeds</h5>
                        <div class="row">
                        ...
                        <form action="{{url('/society/services/ps/store')}}" method="post" id="psadd" class="row g-3">
                            @csrf
                            <div class="col-md-3">
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row margindiv">
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingName" name="no_of_varieties" placeholder="Your Others No." required>
                                            <label for="floatingName">No of Varieties</label>
                                        </div>
                                        <div class="invalid-feedback">Please enter your varieties number.</div>
                                    </div>
                                </div>
                                ...
                                <div class="row margindiv">
                                    ...
                                    <div class="invalid-feedback">Quaality</div>.
                                </div>
                                <div class="row margindiv">
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                    ...
                                    <div class="invalid-feedback">Sales Physical</div>.
                                </div>

                                <div class="row margindiv">
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingName" name="sales_physical" placeholder="Your Others Amount." required>
                                            <label for="floatingName">Sales</label>
                                        </div>
                                    </div>
                                    <div class="invalid-feedback">Sales Physical</div>.
                                </div>
