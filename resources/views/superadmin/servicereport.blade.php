        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{url('/superadmin/servicereport')}}" method="get" id="servicereportform" class="row g-3">
                    @csrf
                      <div class="row margindiv">
                        <div class="col-md-4">
                            <div class="form-floating">
                              <input type="date" class="form-control" id="floatingName" name="servicereportdate" placeholder="date" value="{{$servicereportdate}}" required>
                              <label for="floatingName">Date</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                          <div class="text-center">
                            <button type="submit" class="btn btn-primary" id="servicereportsubmit">Submit</button>
                          </div>
                      </div>
                  </form
                  </div>
