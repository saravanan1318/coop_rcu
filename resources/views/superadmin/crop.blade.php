    ...
    <div class="d-flex justify-content-between">
        <div class="pagetitle" class="col-sm-6">
            ...
            <ol class="breadcrumb ">
                ...
                <li class="breadcrumb-item"><a href="/superadmin/cropmaster">Crop Master</a></li>
    ...
    <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post">
                ...
                @if(isset($crop))
                <div class="col-md-12">
                  <input type="text" class="form-control" name="crop" value="{{$crop->crop_name}}" placeholder="Crop Name" required>
                </div>
