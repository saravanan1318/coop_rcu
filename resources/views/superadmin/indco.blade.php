...
<main id="main" class="main">
  <div class="pagetitle">
    <h1>Report on Indco</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/society/dashboard">Dashboard</a></li>
        <li class="breadcrumb-item">Indco</li>
...
{{--                        </table>--}}
                        ...
                        <table class="stripe table-bordered table-info " id="data-table">
                            ...
                            <tr>
                                ...
                                <th scope="col">3 Month dues</th>
                                <th scope="col">3-6 Month dues</th>
                                <th scope="col">Outstanding for more than 6 month </th>
                            </tr>
