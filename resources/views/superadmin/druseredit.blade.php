    ...
    <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post">
                ...
                @if(isset($druser))
                <div class="col-md-6">
                  <input type="text" class="form-control" name="username" value="{{$druser->username}}" placeholder="User Name" required>
                </div>
                <div class="col-md-6">
                  <input type="text" class="form-control" name="name" value="{{$druser->name}}" placeholder="Name" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <select id="region" name="region" class="form-select" required>
                    <option value="{{$druser->region_id}}">{{$druser->region_name}}</option>
                ...
                <div class="col-md-6">
                  <select id="circle" name="circle" class="form-select" required>
                    <option value="{{$druser->circle_id}}">{{$druser->circle_name}}</option>
