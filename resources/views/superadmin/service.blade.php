    ...
    <div class="d-flex justify-content-between">
        <div class="pagetitle" class="col-sm-6">
            ...
            <ol class="breadcrumb ">
                ...
                <li class="breadcrumb-item"><a href="/superadmin/servicemaster">Service Master</a></li>
    ...
    <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post">
                ...
                @if(isset($service))
                <div class="col-md-12">
                  <input type="text" class="form-control" name="service" value="{{$service->services_name}}" placeholder="Service Name" required>
                </div>
